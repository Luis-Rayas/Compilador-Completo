...
public class Table {
    ...
    public boolean addTableRow(TableRow to_add) {
        ...
        if (result == null) {
            ...
            AnalizadorSemantico.errors.add("Error en variable " + to_add.id + ", ya ha sido declarada");
        }
        return false;
    }
    ...
    public boolean addTableRow(String id, Object value, String type, int offset) {
        ...
        if (result == null) {
            ...
            AnalizadorSemantico.errors.add("Error en variable " + id + ", ya ha sido declarada");
        }
        return false;
    }
